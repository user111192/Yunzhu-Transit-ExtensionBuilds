...
import top.xfunny.block.SchindlerZLine3Keypad1;
...
import top.xfunny.client.util.ArrayListToString;
import top.xfunny.client.util.TransformPositionX;
...
public class RenderSchindlerZLine3Keypad1 extends BlockEntityRenderer<SchindlerZLine3Keypad1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public void render(SchindlerZLine3Keypad1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        number1.setTexture(new Identifier(top.xfunny.Init.MOD_ID, "textures/block/schindler_z_line_keypad/number1.png"));
        ...
        number2.setTexture(new Identifier(top.xfunny.Init.MOD_ID, "textures/block/schindler_z_line_keypad/number2.png"));
        ...
        number3.setTexture(new Identifier(top.xfunny.Init.MOD_ID, "textures/block/schindler_z_line_keypad/number3.png"));
        ...
        number4.setTexture(new Identifier(top.xfunny.Init.MOD_ID, "textures/block/schindler_z_line_keypad/number4.png"));
        ...
        number5.setTexture(new Identifier(top.xfunny.Init.MOD_ID, "textures/block/schindler_z_line_keypad/number5.png"));
        ...
        number6.setTexture(new Identifier(top.xfunny.Init.MOD_ID, "textures/block/schindler_z_line_keypad/number6.png"));
        ...
        number7.setTexture(new Identifier(top.xfunny.Init.MOD_ID, "textures/block/schindler_z_line_keypad/number7.png"));
        ...
        number8.setTexture(new Identifier(top.xfunny.Init.MOD_ID, "textures/block/schindler_z_line_keypad/number8.png"));
        ...
        number9.setTexture(new Identifier(top.xfunny.Init.MOD_ID, "textures/block/schindler_z_line_keypad/number9.png"));
        ...
        lobby.setTexture(new Identifier(top.xfunny.Init.MOD_ID, "textures/block/schindler_z_line_keypad/lobby.png"));
        ...
        number0.setTexture(new Identifier(top.xfunny.Init.MOD_ID, "textures/block/schindler_z_line_keypad/number0.png"));
        ...
        basement.setTexture(new Identifier(top.xfunny.Init.MOD_ID, "textures/block/schindler_z_line_keypad/basement.png"));
        ...
        accessibility.setTexture(new Identifier(top.xfunny.Init.MOD_ID, "textures/block/schindler_z_line_keypad/accessibility.png"));
