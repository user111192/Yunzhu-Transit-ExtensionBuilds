...
import top.xfunny.mod.block.MitsubishiGPS3Button2WithoutScreen;
...
public class RenderMitsubishiGPS3Button2WithoutScreen extends BlockEntityRenderer<MitsubishiGPS3Button2WithoutScreen.BlockEntity> implements DirectionHelper, IGui, IBlock {

    private static final int HOVER_COLOR = 0xFFFFCC66;
    private static final int PRESSED_COLOR = 0xFFFEE1A9;
    private static final Identifier BUTTON_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_gps3_button_2.png");
    private static final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_gps3_button_2_arrow.png");

    public RenderMitsubishiGPS3Button2WithoutScreen(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiGPS3Button2WithoutScreen.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        buttonUp.setTexture(BUTTON_LIGHT_TEXTURE);
        ...
        buttonDown.setTexture(BUTTON_LIGHT_TEXTURE);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiGPS3Button2WithoutScreen.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
