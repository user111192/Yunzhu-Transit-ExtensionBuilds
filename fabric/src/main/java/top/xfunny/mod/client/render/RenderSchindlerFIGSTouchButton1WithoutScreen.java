...
public class RenderSchindlerFIGSTouchButton1WithoutScreen extends BlockEntityRenderer<SchindlerFIGSTouchButton1WithoutScreen.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderSchindlerFIGSTouchButton1WithoutScreen(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(SchindlerFIGSTouchButton1WithoutScreen.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        buttonLayout.setMargin(0, 1.3F / 16, 0, 0);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            SchindlerFIGSTouchButton1WithoutScreen.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
