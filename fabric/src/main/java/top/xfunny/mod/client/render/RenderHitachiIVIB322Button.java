...
import top.xfunny.mod.block.HitachiIVIB322Button;
...
public class RenderHitachiIVIB322Button extends BlockEntityRenderer<HitachiIVIB322Button.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    @Override
    public void render(HitachiIVIB322Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiIVIB322Button.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
