...
import top.xfunny.mod.block.HitachiHB181AButton;
...
public class RenderHitachiHB181AButton extends BlockEntityRenderer<HitachiHB181AButton.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiHB181AButton(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiHB181AButton.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiHB181AButton.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
