...
import top.xfunny.mod.block.HitachiHSB820Button;
...
public class RenderHitachiHSB820Button extends BlockEntityRenderer<HitachiHSB820Button.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiHSB820Button(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiHSB820Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        parentLayout.setParentDimensions(4F / 16, 9.01F / 16);
        ...
        buttonLayout.setMargin(0, 0.75F / 16, 0, 0);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiHSB820Button.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (buttonDescriptor.hasDownButton()) {
            if (buttonDescriptor.hasUpButton()) {
                downButtonGroup.setMargin(0, 0.375F / 16, 0, 0);
            }
