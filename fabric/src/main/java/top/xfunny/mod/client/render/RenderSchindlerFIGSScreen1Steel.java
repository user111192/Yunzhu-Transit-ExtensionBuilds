...
import top.xfunny.mod.block.SchindlerFIGSScreen1SteelEven;
...
public class RenderSchindlerFIGSScreen1Steel<T extends LiftPanelBase.BlockEntityBase> extends BlockEntityRenderer<T> implements DirectionHelper, IGui, IBlock {
    private final boolean isOdd;

    public RenderSchindlerFIGSScreen1Steel(Argument dispatcher, Boolean isOdd) {
        super(dispatcher);
        this.isOdd = isOdd;
    }
    ...
    public void render(T blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            SchindlerFIGSScreen1SteelEven.LiftCheck(trackPosition, (floorIndex, lift) -> sortedPositionsAndLifts.add(new ObjectObjectImmutablePair<>(trackPosition, lift)));
        });
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        6.5F,
                        0xFFFFFFFF);
                liftFloorDisplayView.setTextureId("schindler_fi_gs_700_screen_display");
                ...
                liftFloorDisplayView.setMargin(0.875F / 16, 1.225F / 16, 0.1F/16, 0);
                ...
                liftArrowView_left.setTexture(new Identifier(Init.MOD_ID, "textures/block/schindler_fi_gs_arrow_3.png"));
                liftArrowView_left.setAnimationScrolling(false, 0.05F);
                liftArrowView_left.setDimension(1.6F / 16);
                liftArrowView_left.setMargin(-0.35F / 16, 1.825F / 16, 0, 0);
