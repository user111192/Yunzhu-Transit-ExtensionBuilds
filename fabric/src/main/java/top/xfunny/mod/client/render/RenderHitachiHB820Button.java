...
import top.xfunny.mod.block.HitachiHB820Button;
...
public class RenderHitachiHB820Button extends BlockEntityRenderer<HitachiHB820Button.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiHB820Button(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiHB820Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        parentLayout.setParentDimensions(4F / 16, 9.235F / 16);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiHB820Button.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
