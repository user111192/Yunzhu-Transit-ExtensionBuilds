...
import top.xfunny.mod.block.MitsubishiGPS3Button1WithoutScreen;
...
public class RenderMitsubishiGPS3Button1WithoutScreen extends BlockEntityRenderer<MitsubishiGPS3Button1WithoutScreen.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderMitsubishiGPS3Button1WithoutScreen(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiGPS3Button1WithoutScreen.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiGPS3Button1WithoutScreen.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
