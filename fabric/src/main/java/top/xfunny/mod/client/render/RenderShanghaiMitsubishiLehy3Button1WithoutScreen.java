...
import top.xfunny.mod.block.ShanghaiMitsubishiLehy3Button1WithoutScreen;
...
public class RenderShanghaiMitsubishiLehy3Button1WithoutScreen extends BlockEntityRenderer<ShanghaiMitsubishiLehy3Button1WithoutScreen.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderShanghaiMitsubishiLehy3Button1WithoutScreen(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(ShanghaiMitsubishiLehy3Button1WithoutScreen.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        buttonLayout.setMargin(0, 1.75F / 16, 0, 0);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            ShanghaiMitsubishiLehy3Button1WithoutScreen.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
