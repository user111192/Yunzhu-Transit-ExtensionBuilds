...
public class RenderKoneMButton2 extends BlockEntityRenderer<KoneMButton2.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    private final int HOVER_COLOR = 0xFFFFDDDD;
    ...
    private final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(Init.MOD_ID, "textures/block/kone_m_button_2_light.png");
    ...
    public void render(KoneMButton2.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        storedMatrixTransformations1.add(graphicsHolder -> {
            ...
            graphicsHolder.translate(0, -0.075, 7.9F/16 - SMALL_OFFSET);
        });
        ...
        buttonLight.setTexture(new Identifier(Init.MOD_ID, "textures/block/kone_m_button_2_light.png"), false);
        buttonLight.setWidth(1.25F / 16);
        buttonLight.setHeight(0.65F / 16);
