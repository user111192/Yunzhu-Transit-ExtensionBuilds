...
import top.xfunny.mod.block.HitachiHB628Button;
...
public class RenderHitachiHB628Button extends BlockEntityRenderer<HitachiHB628Button.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiHB628Button(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiHB628Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiHB628Button.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
