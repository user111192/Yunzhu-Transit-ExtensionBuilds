...
import top.xfunny.mod.block.HitachiHB658Button;
...
public class RenderHitachiHB658Button extends BlockEntityRenderer<HitachiHB658Button.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiHB658Button(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiHB658Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiHB658Button.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
