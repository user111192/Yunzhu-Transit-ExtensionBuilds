...
public class OtisSPEC90Button1Black extends LiftButtonsBase {

    public OtisSPEC90Button1Black() {
        super(true, true);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.OTIS_SPEC_90_BUTTON_1_BLACK.get(), pos, state);
        }
    }
