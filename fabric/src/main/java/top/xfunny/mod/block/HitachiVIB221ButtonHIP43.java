...
public class HitachiVIB221ButtonHIP43 extends LiftButtonsBase {
    public HitachiVIB221ButtonHIP43() {
        super(true, true);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new HitachiVIB221ButtonHIP43.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.HITACHI_VIB221_BUTTON_HIP43.get(), pos, state);
        }
    }
}
