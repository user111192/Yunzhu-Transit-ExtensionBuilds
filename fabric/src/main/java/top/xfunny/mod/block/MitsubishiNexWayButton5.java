...
public class MitsubishiNexWayButton5 extends LiftButtonsBase {

    public MitsubishiNexWayButton5() {
        super(true, true);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.MITSUBISHI_NEXWAY_BUTTON_5.get(), pos, state);
        }
    }
