...
public class SchindlerLineaButton2Black extends LiftButtonsBase {

    public SchindlerLineaButton2Black() {
        super(true, true);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.SCHINDLER_LINEA_BUTTON_2_BLACK.get(), pos, state);
        }
    }
