...
public class TonicDSScreen1Even extends LiftPanelBase {
    public TonicDSScreen1Even() {
        super(false);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new TonicDSScreen1Even.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        ...
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.TONIC_DS_SCREEN_1_EVEN.get(), pos, state);
        }
    }
