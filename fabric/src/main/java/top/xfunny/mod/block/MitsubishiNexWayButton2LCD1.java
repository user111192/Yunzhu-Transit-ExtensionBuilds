...
public class MitsubishiNexWayButton2LCD1 extends LiftButtonsBase {

    public MitsubishiNexWayButton2LCD1() {
        super(true, true);
    }
    ...
    public VoxelShape getOutlineShape2(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return IBlock.getVoxelShapeByDirection(single ? 5.85 : 6.7, 0.6, 0, single ? 10.15 : 9.3, 12.4, 0.05, IBlock.getStatePropertySafe(state, FACING));
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.MITSUBISHI_NEXWAY_BUTTON_2_LCD_1.get(), pos, state);
        }
    }
