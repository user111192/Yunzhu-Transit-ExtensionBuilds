...
public class MitsubishiMaxiezButton1Silver extends LiftButtonsBase {

    public MitsubishiMaxiezButton1Silver() {
        super(true, true);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.MITSUBISHI_MAXIEZ_BUTTON_1_SILVER.get(), pos, state);
        }
    }
