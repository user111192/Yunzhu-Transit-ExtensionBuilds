...
public class SchindlerDSeriesScreen2GreenEven extends LiftPanelBase {
    public SchindlerDSeriesScreen2GreenEven() {
        super(false);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new SchindlerDSeriesScreen2GreenEven.BlockEntity(blockPos, blockState);
    }
