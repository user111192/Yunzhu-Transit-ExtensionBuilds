...
public class MitsubishiNexWayButton1Segmented extends LiftButtonsBase {

    public MitsubishiNexWayButton1Segmented() {
        super(true, true);
    }
    ...
    public VoxelShape getOutlineShape2(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return IBlock.getVoxelShapeByDirection(single ? 6.225 : 6.825, 0.585, 0, single ? 9.775 : 9.175, 12.37, 0.5, IBlock.getStatePropertySafe(state, FACING));
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.MITSUBISHI_NEXWAY_BUTTON_1_SEGMENTED.get(), pos, state);
        }
    }
