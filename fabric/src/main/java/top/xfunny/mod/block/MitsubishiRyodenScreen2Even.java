...
public class MitsubishiRyodenScreen2Even extends LiftPanelBase {
    public MitsubishiRyodenScreen2Even() {
        super(false);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new MitsubishiRyodenScreen2Even.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        ...
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.MITSUBISHI_RYODEN_SCREEN_2_EVEN.get(), pos, state);
        }
    }
