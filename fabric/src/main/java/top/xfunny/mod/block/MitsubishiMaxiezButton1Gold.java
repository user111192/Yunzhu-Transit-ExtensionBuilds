...
public class MitsubishiMaxiezButton1Gold extends LiftButtonsBase {

    public MitsubishiMaxiezButton1Gold() {
        super(true, true);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.MITSUBISHI_MAXIEZ_BUTTON_1_GOLD.get(), pos, state);
        }
    }
