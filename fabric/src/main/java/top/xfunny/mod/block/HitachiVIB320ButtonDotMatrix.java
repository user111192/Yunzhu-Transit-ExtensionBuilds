...
public class HitachiVIB320ButtonDotMatrix extends LiftButtonsBase {
    public HitachiVIB320ButtonDotMatrix() {
        super(true, true);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new HitachiVIB320ButtonDotMatrix.BlockEntity(blockPos, blockState);
    }
