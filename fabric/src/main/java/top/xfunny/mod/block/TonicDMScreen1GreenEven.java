...
public class TonicDMScreen1GreenEven extends LiftPanelBase {
    public TonicDMScreen1GreenEven() {
        super(false);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new TonicDMScreen1GreenEven.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        ...
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.TONIC_DM_SCREEN_1_GREEN_EVEN.get(), pos, state);
        }
    }
}
