...
public class HitachiVIB221ButtonDotMatrix extends LiftButtonsBase {
    public HitachiVIB221ButtonDotMatrix() {
        super(true, true);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new HitachiVIB221ButtonDotMatrix.BlockEntity(blockPos, blockState);
    }
