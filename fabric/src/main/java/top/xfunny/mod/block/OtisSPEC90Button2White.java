...
public class OtisSPEC90Button2White extends LiftButtonsBase {

    public OtisSPEC90Button2White() {
        super(true, true);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.OTIS_SPEC_90_BUTTON_2_WHITE.get(), pos, state);
        }
    }
