...
public class MitsubishiNexWayButton2Segmented extends LiftButtonsBase {

    public MitsubishiNexWayButton2Segmented() {
        super(true, true);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.MITSUBISHI_NEXWAY_BUTTON_2_SEGMENTED.get(), pos, state);
        }
    }
