...
public class OtisSPEC90Button1White extends LiftButtonsBase {

    public OtisSPEC90Button1White() {
        super(true, true);
    }
    ...
    public VoxelShape getOutlineShape2(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return IBlock.getVoxelShapeByDirection(!single ? 6.875 : 6.375, 0.9, 0, !single ? 9.125 : 9.625, 9.65, 0.2, IBlock.getStatePropertySafe(state, FACING));
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.OTIS_SPEC_90_BUTTON_1_WHITE.get(), pos, state);
        }
    }
