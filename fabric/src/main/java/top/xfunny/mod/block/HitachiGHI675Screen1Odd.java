...
public class HitachiGHI675Screen1Odd extends LiftPanelBase {
    public HitachiGHI675Screen1Odd() {
        super(true);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new HitachiGHI675Screen1Odd.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        ...
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.HITACHI_GHI675_SCREEN_ODD.get(), pos, state);
        }
    }
