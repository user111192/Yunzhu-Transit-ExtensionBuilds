...
public class HitachiVIB679Button extends LiftButtonsBase {
    public HitachiVIB679Button() {
        super(true, true);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new HitachiVIB679Button.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.HITACHI_VIB679_BUTTON.get(), pos, state);
        }
    }
}
