...
public class SchindlerLineaButton1White extends LiftButtonsBase {

    public SchindlerLineaButton1White() {
        super(true, true);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.SCHINDLER_LINEA_BUTTON_1_WHITE.get(), pos, state);
        }
    }
