...
public class HitachiGHL673Lantern1Even extends LiftButtonsBase {
    ...
    public VoxelShape getOutlineShape2(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        switch (IBlock.getStatePropertySafe(state, SIDE)) {
            case LEFT:
                return IBlock.getVoxelShapeByDirection(14.75, 5.25, 0, 16, 11.235, 0.45, IBlock.getStatePropertySafe(state, FACING));

            case RIGHT:
                return IBlock.getVoxelShapeByDirection(0, 5.25, 0, 1.25, 11.235, 0.45, IBlock.getStatePropertySafe(state, FACING));
