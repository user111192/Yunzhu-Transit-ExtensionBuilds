...
public class SchindlerFIGSTouchButton1 extends LiftButtonsBase {

    public SchindlerFIGSTouchButton1() {
        super(true, true);
    }
    ...
    public VoxelShape getOutlineShape2(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return IBlock.getVoxelShapeByDirection(single ? 6.875 : 7.125, 0, 0, single ? 9.125 : 8.875, 7, 0.1, IBlock.getStatePropertySafe(state, FACING));
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.SCHINDLER_FI_GS_TOUCH_BUTTON_1.get(), pos, state);
        }
    }
