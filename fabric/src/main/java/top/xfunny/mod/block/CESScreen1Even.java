...
public class CESScreen1Even extends LiftPanelBase {
    public CESScreen1Even() {
        super(false);
    }
    ...
    public VoxelShape getOutlineShape2(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        switch (IBlock.getStatePropertySafe(state, SIDE)) {
            ...
            case RIGHT:
                return IBlock.getVoxelShapeByDirection(0, 10, 0, 5.5, 13.25, 0.09, IBlock.getStatePropertySafe(state, FACING));
            default:
