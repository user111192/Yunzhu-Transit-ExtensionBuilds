...
public class TonicDMScreen1RedEven extends LiftPanelBase {
    public TonicDMScreen1RedEven() {
        super(false);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new TonicDMScreen1RedEven.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        ...
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.TONIC_DM_SCREEN_1_RED_EVEN.get(), pos, state);
        }
    }
}
