...
public class SchindlerFIGSButton1Steel extends LiftButtonsBase {

    public SchindlerFIGSButton1Steel() {
        super(true, true);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.SCHINDLER_FI_GS_BUTTON_1_STEEL.get(), pos, state);
        }
    }
