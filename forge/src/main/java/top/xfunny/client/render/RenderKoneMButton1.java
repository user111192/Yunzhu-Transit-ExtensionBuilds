...
import top.xfunny.block.KoneMButton1;
...
public class RenderKoneMButton1 extends BlockEntityRenderer<KoneMButton1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    private static final Identifier ARROW_TEXTURE = new Identifier(top.xfunny.Init.MOD_ID, "textures/block/kone_m_arrow_1.png");
    private static final Identifier BUTTON_TEXTURE = new Identifier(top.xfunny.Init.MOD_ID, "textures/block/kone_m_button_1.png");
    private static final Identifier LIGHT_TEXTURE = new Identifier(top.xfunny.Init.MOD_ID, "textures/block/kone_m_button_1_light.png");
