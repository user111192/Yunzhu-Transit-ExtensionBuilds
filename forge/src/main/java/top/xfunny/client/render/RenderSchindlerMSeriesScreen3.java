...
public class RenderSchindlerMSeriesScreen3<T extends LiftButtonsBase.BlockEntityBase> extends BlockEntityRenderer<T> implements DirectionHelper, IGui, IBlock {
    ...
    public void render(T blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        parentLayout.setWidth(top.xfunny.client.view.LayoutSize.MATCH_PARENT);
        parentLayout.setHeight(top.xfunny.client.view.LayoutSize.MATCH_PARENT);

        final FrameLayout screenLayout = new FrameLayout();
        screenLayout.setBasicsAttributes(world, blockEntity.getPos2());
        screenLayout.setWidth(top.xfunny.client.view.LayoutSize.WRAP_CONTENT);
        screenLayout.setHeight(top.xfunny.client.view.LayoutSize.WRAP_CONTENT);
        ...
        final top.xfunny.client.view.LineComponent line = new top.xfunny.client.view.LineComponent();
        line.setBasicsAttributes(world, blockEntity.getPos2());

        final top.xfunny.client.view.LineComponent buttonLine = new top.xfunny.client.view.LineComponent();
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                final top.xfunny.client.view.LiftFloorDisplayView liftFloorDisplayView = new top.xfunny.client.view.LiftFloorDisplayView();
                ...
                liftFloorDisplayView.setTextAlign(top.xfunny.client.view.LiftFloorDisplayView.TextAlign.RIGHT);//文字对齐方式，center为居中对齐，left为左对齐，right为右对齐
