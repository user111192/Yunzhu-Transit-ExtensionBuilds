...
import top.xfunny.block.base.DirectionalBlock;
...
import top.xfunny.block.PATTicketBarrier;

import java.util.List;

public class PATTicketBarrierBareBlock extends DirectionalBlock {
    ...
    public PATTicketBarrierBareBlock(BlockSettings settings) {
        super(settings);
    }
