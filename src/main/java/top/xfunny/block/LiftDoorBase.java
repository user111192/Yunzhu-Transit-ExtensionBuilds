...
public abstract class LiftDoorBase extends BlockPSDAPGBase implements BlockWithEntity {
    ...
    public static abstract class BlockEntityBase extends BlockEntityExtension implements IGui {
        ...
        private boolean receivedRedstonePower(World world, BlockPos pos, BlockState state) {
            ...
            final Direction otherDirection = side == IBlock.EnumSide.LEFT ? facing.rotateYClockwise() : facing.rotateYCounterclockwise();
            final BlockPos platformPos = (half == IBlock.DoubleBlockHalf.UPPER) ? pos.down(2) : pos.down(1);
