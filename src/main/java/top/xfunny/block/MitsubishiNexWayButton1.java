...
public class MitsubishiNexWayButton1 extends LiftButtonsBase {
	...
	public VoxelShape getOutlineShape2(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
		return IBlock.getVoxelShapeByDirection(6, 1, 0, 10, 13, 1, IBlock.getStatePropertySafe(state, FACING));
	}
	...
	public static class BlockEntity extends BlockEntityBase {
		public BlockEntity(BlockPos pos, BlockState state) {
			super(BlockEntityTypes.MITSUBISHI_NEXWAY_BUTTON_1.get(), pos, state, false);
		}
	}
