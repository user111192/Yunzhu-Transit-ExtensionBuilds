...
public class TextureList {
    ...
    public TextureCache.DynamicResource getMitsubishiNexWayButton1Display(String originalText, int textColor) {
        return TextureCache.instance.getResource(String.format("mitsubishi_nexway_button_1_%s", originalText), () -> YteRouteMapGenerator.generateImage(originalText, textColor, FontList.instance.mitsubishi_modern, 5, 0), TextureCache.DefaultRenderingColor.BLACK);
    }
}
