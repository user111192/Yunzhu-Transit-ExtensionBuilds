...
public class RenderSchindlerMSeriesTouchButton extends BlockEntityRenderer<SchindlerMSeriesTouchButton.BlockEntity> implements DirectionHelper, IGui, IBlock {
	...
	private static final Identifier BUTTON_TEXTURE_UP = new Identifier(Init.MOD_ID, "textures/block/schindler_m_series_touch_button_up.png");
	private static final Identifier BUTTON_TEXTURE_DOWN = new Identifier(Init.MOD_ID, "textures/block/schindler_m_series_touch_button_down.png");
	...
	public void render(SchindlerMSeriesTouchButton.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay){
		...
		blockEntity.forEachTrackPosition(trackPosition -> {
			...
			SchindlerMSeriesTouchButton.hasButtonsClient(trackPosition, buttonStates, (floorIndex, lift) -> {
		...
		if (hitResult == null || !IBlock.getStatePropertySafe(blockState, SchindlerMSeriesTouchButton.UNLOCKED)) {
